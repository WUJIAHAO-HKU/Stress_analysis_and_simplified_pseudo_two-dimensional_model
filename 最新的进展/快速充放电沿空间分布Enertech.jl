...
annotate!(neg_center_conc, maximum([maximum(conc) for conc in concentration_p2d_spatial])*0.30 + 0.65, 
         text("Negative\nElectrode", 9, :center, :bold))
annotate!(pos_center_conc, maximum([maximum(conc) for conc in concentration_p_p2d_spatial])- 0.7, 
         text("Positive\nElectrode", 9, :center, :bold))
annotate!(separator_mid, maximum([maximum(conc) for conc in concentration_p2d_spatial])*0.70 - 0.18, 
...
annotate!(pos_center_stress, maximum([maximum(stress) for stress in stress_p_p2d_spatial])+ 0.00040, 
         text("Positive\nElectrode", 9, :center, :bold))
annotate!(separator_mid, maximum([maximum(stress) for stress in stress_p2d_spatial])*0.40 - 0.00028, 
         text("Separator", 9, :center, :italic, :gray))
...
annotate!(neg_center_reaction, maximum([maximum(curr) for curr in reaction_current_p2d_spatial])*0.20 - 0.4, 
         text("Negative\nElectrode", 9, :center, :bold))
annotate!(pos_center_reaction, maximum([maximum(curr) for curr in reaction_current_p_p2d_spatial]) +1.4, 
         text("Positive\nElectrode", 9, :center, :bold))
annotate!(separator_mid, maximum([maximum(curr) for curr in reaction_current_p2d_spatial])- 3.00, 
         text("Separator", 9, :center, :italic, :gray))
...
annotate!(pos_center_over, maximum([maximum(over) for over in overpotential_p_p2d_spatial])+0.05, 
         text("Positive\nElectrode", 9, :center, :bold))
annotate!(separator_mid, maximum([maximum(over) for over in overpotential_p2d_spatial]) - 0.105, 
         text("Separator", 9, :center, :italic, :gray))
