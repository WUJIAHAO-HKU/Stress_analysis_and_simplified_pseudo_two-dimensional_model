...
# 恒流放电参数
charging_current = 4.0    # 放电电流（A）
charge_time = 2000        # 放电总时间（秒）

# 锯齿波充电参数
discharge_amplitude = 4.0 # 充电峰值电流绝对值（A）
...
# 图形修饰
xlims!(0, total_time)
title!("Constant Charging → Sawtooth Discharging")
savefig("constant_charge_sawtooth_discharge.pdf")
